      ...
      <View style={styles.chips}>
        {options.map((opt) => (
          <TouchableOpacity
            ...
            onPress={() => {
              // Whitelist guard: only emit values from the configured option set.
              if (allowed.has(opt)) onToggle(opt);
            }}
          >
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <ChipGroup
        ...
        selected={props.selectedPalettes}
